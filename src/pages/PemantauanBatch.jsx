    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 10, height: '100%', boxSizing: 'border-box' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexShrink: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            <div style={{ fontSize: 17, fontWeight: 900, color: '#0F172A', lineHeight: 1.1 }}>Pemantauan Batch</div>
            <div style={{ fontSize: 11, fontWeight: 700, color: '#64748B', marginTop: 2 }}>Real-time telemetry · B24-09</div>
          </div>
        </div>
        {/* Time range pills */}
      ...
      <div style={{ display: 'flex', gap: 10, flex: 1, minHeight: 0 }}>
        ...
        {/* Sensor Panels */}
        <div style={{ width: 185, display: 'flex', flexDirection: 'column', gap: 10, flexShrink: 0 }}>
          {/* Temp */}
          <div
            style={{
              flex: 1, background: 'linear-gradient(135deg, #FFF7ED, #FFEDD5)',
              borderRadius: 18, border: '2px solid #FED7AA', padding: '13px 15px',
          ...
          >
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative', zIndex: 1 }}>
              <span style={{ fontSize: 11, fontWeight: 900, color: '#C2410C', letterSpacing: '0.07em', textTransform: 'uppercase' }}>Suhu / Zona A</span>
            ...
            <div style={{ my: 'auto', position: 'relative', zIndex: 1 }}>
              <span style={{ fontSize: 38, fontWeight: 900, color: '#EA580C', fontFamily: "'JetBrains Mono', monospace", lineHeight: 1, letterSpacing: '-0.02em' }}>37.5°</span>
            </div>
            <div style={{ position: 'relative', zIndex: 1 }}>
              <div style={{ padding: '4px 9px', background: '#FEF3C7', borderRadius: 999, display: 'inline-block', border: '1px solid #FDE68A' }}>
                <span style={{ fontSize: 9.5, fontWeight: 800, color: '#92400E', fontFamily: "'JetBrains Mono', monospace" }}>TARGET: 37.8°C</span>
              </div>
            </div>
          </div>
          {/* Humidity */}
          <div
            style={{
              ...
              borderRadius: 18, border: '2px solid #BFDBFE', padding: '13px 15px',
              display: 'flex', flexDirection: 'column', justifyContent: 'space-between',
          ...
          >
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative', zIndex: 1 }}>
              <span style={{ fontSize: 11, fontWeight: 900, color: '#1D4ED8', letterSpacing: '0.07em', textTransform: 'uppercase' }}>Hum / Zona A</span>
              <span className="material-symbols-rounded" style={{ fontSize: 20, color: '#3B82F6' }}>water_drop</span>
            </div>
            <div style={{ my: 'auto', position: 'relative', zIndex: 1 }}>
              <span style={{ fontSize: 38, fontWeight: 900, color: '#2563EB', fontFamily: "'JetBrains Mono', monospace", lineHeight: 1, letterSpacing: '-0.02em' }}>65.2%</span>
            </div>
            <div style={{ position: 'relative', zIndex: 1 }}>
              <div style={{ padding: '4px 9px', background: '#DBEAFE', borderRadius: 999, display: 'inline-block', border: '1px solid #BFDBFE' }}>
                <span style={{ fontSize: 9.5, fontWeight: 800, color: '#1E40AF', fontFamily: "'JetBrains Mono', monospace" }}>TARGET: 65.0%</span>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10, position: 'relative', zIndex: 1 }}>
            <span style={{ fontSize: 13, fontWeight: 900, color: '#0F172A' }}>Grafik Telemetri · Rentang {range}</span>
            <div style={{ display: 'flex', gap: 14 }}>
              {[['#EA580C','Suhu (°C)'],['#2563EB','Kelembaban (%)']].map(([c,l]) => (
                <div key={l} style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  <div style={{ width: 18, height: 3.5, background: c, borderRadius: 2 }} />
                  <span style={{ fontSize: 11, fontWeight: 800, color: '#475569' }}>{l}</span>
                </div>
              ))}
            </div>
          </div>

          <div style={{ flex: 1, position: 'relative', background: '#F8FAFC', borderRadius: 12, overflow: 'hidden', border: '1.5px solid #E2E8F0' }}>
            ...
            <div style={{ position: 'absolute', top: 16, left: 10, height: 'calc(100% - 34px)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              {['100','75','50','25'].map(v => (
                <span key={v} style={{ fontSize: 9.5, fontWeight: 800, color: '#64748B', fontFamily: "'JetBrains Mono', monospace" }}>{v}</span>
              ))}
            </div>
            {/* X axis labels */}
